                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="form-check mt-3">
                            <input class="form-check-input" type="checkbox" name="role_dosen" value="1"
                              id="flexCheckDefault" @if ($user->getRoleNames()->contains('dosen')) checked @endif />
                            <label class="form-check-label" for="flexCheckDefault">
                                Dosen
                            </label>
                        </div>
                        <div class="form-check mt-3">
                            <input class="form-check-input" type="checkbox" name="role_admin" value="1"
                              id="flexCheckDefault" @if ($user->getRoleNames()->contains('admin')) checked @endif />
                            <label class="form-check-label" for="flexCheckDefault">
                                Admin
                            </label>
                        </div>
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5 fv-row">
                            ...
                            <input type="text" name="nim" class="form-control mb-2"
                                placeholder="Nomor Induk Mahasiswa" value="{{  $user->mahasiswa?->nim }}" />
                            @error('nim')
                                <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select name="jenis_kelamin_mahasiswa" class="form-select mb-2" >
                                        ...
                                        <option value="L" @if ($user->mahasiswa?->jenis_kelamin == 'L') selected @endif>Laki-laki
                                        </option>
                                        <option value="P" @if ($user->mahasiswa?->jenis_kelamin == 'P') selected @endif>Perempuan
                                        </option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="agama_mahasiswa" class="form-select mb-2" >
                                        ...
                                        <option value="Islam" @if ($user->mahasiswa?->agama == 'Islam') selected @endif>Islam
                                        </option>
                                        <option value="Kristen" @if ($user->mahasiswa?->agama == 'Kristen') selected @endif>Kristen
                                        </option>
                                        <option value="Katolik" @if ($user->mahasiswa?->agama == 'Katolik') selected @endif>Katolik
                                        </option>
                                        <option value="Hindu" @if ($user->mahasiswa?->agama == 'Hindu') selected @endif>Hindu
                                        </option>
                                        <option value="Budha" @if ($user->mahasiswa?->agama == 'Budha') selected @endif>Budha
                                        </option>
                                        <option value="Konghucu" @if ($user->mahasiswa?->agama == 'Konghucu') selected @endif>
                                            Konghucu
                                        </option>
                                    </select>
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <textarea name="alamat_mahasiswa" class="form-control mb-2" placeholder="Alamat" >{{ $user->mahasiswa?->alamat }}</textarea>
                    ...
                    <div class="card-body pt-0">
                        <div class="mb-5 fv-row">
                            ...
                            <input type="text" name="nidn" class="form-control mb-2"
                                placeholder="Nomor Induk Dosen Nasional" value="{{ $user->dosen?->nidn }}" />
                            @error('nidn')
                                <div class="text-danger fs-7">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <select name="jabatan" class="form-select mb-2" >
                                ...
                                <option value="asisten ahli" @if ($user->dosen?->jabatan == 'asisten ahli') selected @endif>Asisten
                                    Ahli</option>
                                <option value="lektor" @if ($user->dosen?->jabatan == 'lektor') selected @endif>Lektor</option>
                                <option value="lektor kepala" @if ($user->dosen?->jabatan == 'lektor kepala') selected @endif>Lektor
                                    Kepala</option>
                                <option value="guru besar" @if ($user->dosen?->jabatan == 'guru besar') selected @endif>Guru Besar
                                </option>
                            </select>
                            @error('jabatan')
                                <div class="text-danger fs-7">{{ $message }}</div>
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <select name="pendidikan_terakhir" class="form-select mb-2" >
                                ...
                                <option value="S1" @if ($user->dosen?->pendidikan_terakhir == 'S1') selected @endif>S1</option>
                                <option value="S2" @if ($user->dosen?->pendidikan_terakhir == 'S2') selected @endif>S2</option>
                                <option value="S3" @if ($user->dosen?->pendidikan_terakhir == 'S3') selected @endif>S3</option>
                            </select>
                        ...
                        <div class="mb-5 fv-row">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="agama_dosen" class="form-select mb-2" >
                                        <option value="">Pilih Agama</option>
                                        <option value="Islam" @if ($user->dosen?->agama == 'Islam') selected @endif>Islam
                                        </option>
                                        <option value="Kristen" @if ($user->dosen?->agama == 'Kristen') selected @endif>Kristen
                                        </option>
                                        <option value="Katolik" @if ($user->dosen?->agama == 'Katolik') selected @endif>Katolik
                                        </option>
                                        <option value="Hindu" @if ($user->dosen?->agama == 'Hindu') selected @endif>Hindu
                                        </option>
                                        <option value="Budha" @if ($user->dosen?->agama == 'Budha') selected @endif>Budha
                                        </option>
                                        <option value="Konghucu" @if ($user->dosen?->agama == 'Konghucu') selected @endif>
                                            Konghucu
                                        </option>
                                    </select>
                                    @error('agama_dosen')
                            ...
                            <div class="mb-5 fv-row">
                                <label class="required form-label">Alamat</label>
                                <textarea name="alamat_dosen" class="form-control mb-2" placeholder="Alamat" >{{ $user->dosen?->alamat }}</textarea>
                                @error('alamat_dosen')
                                    <div class="text-danger fs-7">{{ $message }}</div>
                                @enderror
                            </div>
