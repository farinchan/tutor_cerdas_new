            ...
            <div class="d-flex flex-column flex-lg-row">
                <div class="flex-lg-row-fluid ">
                    <div class="card">
                                ...
                                <div class="modal fade" tabindex="-1" id="delete_question">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <form
                                                action="{{ route('dosen.kelas.pretestQuestionDelete', [$kelas->kode_kelas, $question->id]) }}"
                                                method="post">
                                                @method('DELETE')
                                                @csrf
                        ...
                        <form
                            action="{{ route('dosen.kelas.pretestQuestionUpdate', [$kelas->kode_kelas, $question->id]) }}"
                            ...
                            <div class="card-footer">
                                <a href="{{ route('dosen.kelas.show', $kelas->kode_kelas) }}"
