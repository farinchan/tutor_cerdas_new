    ...
    <div class="modal fade" tabindex="-1" id="end_exam">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('mahasiswa.kelas.examSelesai', [$kode_kelas, $materi_id]) }}" id="end_exam_form"
                    method="POST">
                    @csrf
...
@section('scripts')
    <script>
        ...
        function selectQuestion(question_id) {
            ...
            $.ajax({
                url: '{{ route('mahasiswa.kelas.examSoal') }}',
                method: 'GET',
                data: {
        ...
        function submitAnswer(choice_id) {
            $.ajax({
                url: '{{ route('mahasiswa.kelas.examJawab') }}',
                method: 'POST',
                headers: {
