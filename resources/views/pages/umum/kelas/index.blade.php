                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="#">
                                            <div class="symbol-label">
                                                <img src="{{ $row->dosen?->user?->getPhoto() }}" alt="Emma Smith" class="w-100">
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                @if ($row->pretest?->soal->count() > 0 )
                                    <a href="{{ route("umum.kelas.pretest", $row->kode_kelas) }}" class="btn btn-primary">{{ __('class.do_it_now') }}</a>
                                    @else
