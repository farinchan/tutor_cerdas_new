                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5"
                            href="{{ route('umum.kelas.historyUjian', [$kode_kelas, $materi_id]) }}">
                                            ...
                                            <div class="d-flex justify-content-start mb-10">
                                                <div class="d-flex flex-column align-items-start">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic"
                                                                src="https://res.cloudinary.com/duuawbwih/image/upload/v1726825426/microchip_muip1f.png" />
                                                        </div>
                                                        <div class="ms-3">
                                                            <a href="#"
                                                                class="fs-5 fw-bold text-info text-hover-primary me-1">"Tutor
                                                                Cerdas AI"</a>
                                                            <span class="text-muted fs-7 mb-1">
                                                                {{ $diskusi->created_at->diffForHumans() }}
                                                            </span>
