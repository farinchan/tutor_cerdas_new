                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="margin-bottom: 15px">
                                <img alt="Logo" src="https://res.cloudinary.com/duuawbwih/image/upload/v1726818246/no-entry_ngccof.png" width="100" height="100" />
                            </div>
                            <div
                                ...
                                <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">
                                    Halo, {{ $mailData['nama'] }} kamu ditolak masuk ke kelas
                                </p>
                                <p style="margin-bottom:2px; color:#7E8299">Mohon maaf, kamu ditolak masuk ke kelas {{ $mailData['nama_kelas'] }}</p>
