                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="margin-bottom: 15px">
                                <img alt="Logo" src="https://res.cloudinary.com/duuawbwih/image/upload/v1726818245/check_m1bluy.png" width="100" height="100" />
                            </div>
                            <div
                                ...
                                <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">
                                    Halo, {{ $mailData['nama'] }} anda telah diterima masuk ke kelas
                                </p>
                                <p style="margin-bottom:2px; color:#7E8299">Selamat, kamu telah diterima masuk ke kelas {{ $mailData['nama_kelas'] }}</p>
                                <p style="margin-bottom:2px; color:#7E8299">Pada Mata Kuliah {{ $mailData['matakuliah'] }} oleh dosen {{ $mailData['dosen'] }}</p>
                                <p style="margin-bottom:2px; color:#7E8299">Silahkan cek materi yang sudah diberikan oleh dosen.</p>
                            </div>
