                    ...
                    <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                        <div style="text-align:center; margin:0 15px 34px 15px">
                            ...
                            <div style="margin-bottom: 15px">
                                <img alt="Logo" src="https://res.cloudinary.com/duuawbwih/image/upload/v1726817144/apologize_lx9ktv.png" width="100" height="100" />
                            </div>
                            <div
                                ...
                                <p style="margin-bottom:9px; color:#181C32; font-size: 22px; font-weight:700">
                                    Halo, {{ $mailData['nama'] }} kamu telah dikeluarkan dari kelas 
                                </p>
                                <p style="margin-bottom:2px; color:#7E8299">Mohon maaf, kamu telah dikeluarkan dari kelas {{ $mailData['nama_kelas'] }}</p>
                                <p style="margin-bottom:2px; color:#7E8299">Pada Mata Kuliah {{ $mailData['matakuliah'] }} oleh dosen {{ $mailData['dosen'] }}</p>
                                <p style="margin-bottom:2px; color:#7E8299">Jika kamu merasa ada kesalahan, silahkan hubungi dosen yang bersangkutan.</p>
                            </div>
                        </div>
                    </td>
                </tr>
