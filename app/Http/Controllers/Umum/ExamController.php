...
class ExamController extends Controller
{
    public function exam($kode_kelas, $id)
    {
        ...
        if (!$materi) {
            return redirect()->route('umum.kelas.index')->with('error', 'Materi tidak ditemukan');
        }
        ...
        return view('pages.umum.materi.exam', $data);
    }
    ...
    public function examSelesai(Request $request, $kode_kelas, $id)
    {
        ...
        return redirect()->route('umum.kelas.historyUjian', [$kode_kelas, $id])->with('success', 'exam selesai');
    }
}
